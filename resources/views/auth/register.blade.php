<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-4">
            ...
            <select name="rol" id="rol" class="w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring focus:rinf-indigo-200 focus:ring-opacity-50">
